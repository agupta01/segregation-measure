...
city_blocks = gpd.read_file(
    '../data/block_2010_data/nhgis0005_shape/nhgis0005_shapefile_tl2010_170_block_2010/IL_block_2010.shp').set_index('GEOID10')
city_rl_cw = pd.read_csv('../data/outputs/Chicago_blocks_2010_crosswalk.csv', dtype={'block_id_2010': str}).set_index('block_id_2010')
