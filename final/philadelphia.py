...
city_blocks = gpd.read_file(
    '../data/block_2010_data/nhgis0005_shape/nhgis0005_shapefile_tl2010_420_block_2010/PA_block_2010.shp').set_index('GEOID10')
city_rl_cw = pd.read_csv('../data/outputs/Philadelphia_blocks_2010_crosswalk.csv', dtype={'block_id_2010': str}).set_index('block_id_2010')
...
client.messages.create(to='+15103785524', from_='+12059272645', body=f"Chunk flip for {CITY_NAME} completed.")
...
# notify chain is done
client.messages.create(to='+15103785524', from_='+12059272645', body=f"Random flip for {CITY_NAME} completed.")
